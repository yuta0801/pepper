...
module.exports = class extends Language {
  ...
  constructor(...args) {
    ...
    this.language = {
      ...
      COMMAND_HEAD_DESCRIPTION: 'メンバーの顔写真がランダムで出てきます。（一部のみ）',
      COMMAND_RIP_DESCRIPTION: '死にます。',
      COMMAND_GOOGLE_DESCRIPTION: 'Googleの画像が落ちてきます。',
      COMMAND_TIME_DESCRIPTION: '今の時間を表示します。',
      COMMAND_TIME: (datetime) => `現在の時刻は${datetime}です。`,
      COMMAND_おはよう_DESCRIPTION: 'ちゃんと起きよう！',
      COMMAND_LENGTH_DESCRIPTION: 'これを打ってから打った文章の文字数を数えます。',
      COMMAND_LENGTH: (len) => `この文章は${len}文字です。`,
      COMMAND_TRAIN_DESCRIPTION: 'TrainfoTwitterから最新の情報5件を表示します。',
      COMMAND_TWEET_DESCRIPTION: 'Keitanのアカウントでツイートします。悪用厳禁',
      COMMAND_SHUTDOWN_DESCRIPTION: '緊急',
      COMMAND_SHUTDOWN: 'システムをシャットダウンしています......',
    }
  }
